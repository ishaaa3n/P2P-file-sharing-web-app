 ...
 * This class handles all CRUD operations for User entities.
 */
public class UserDAO {
    ...
    public boolean createUser(User user) {
        String sql = "INSERT INTO users (username, password, email, ip_address, port, is_online) " +
                     "VALUES (?, ?, ?, ?, ?, ?)";
        ...
        try (Connection conn = DBConnection.getInstance().getConnection();
            ...
            pstmt.setBoolean(6, user.isOnline());
    ...
    public boolean updateUser(User user) {
        String sql = "UPDATE users SET username = ?, email = ?, ip_address = ?, port = ?, " +
                     "is_online = ?, last_login = CURRENT_TIMESTAMP WHERE user_id = ?";
